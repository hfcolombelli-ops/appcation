...
/// Smoke de integração com [IntegrationTestWidgetsFlutterBinding].
/// No CI (Ubuntu) corre com `flutter test … -d linux` (ver `.github/workflows/ci.yml`).
/// Evita [MyApp] + GoogleFonts para ser estável em CI (igual a [widget_test.dart]).
void main() {
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  testWidgets('ecrã de login (smoke integração)', (WidgetTester tester) async {
